...
describe("Arvernus Release Package Update", () => {
	...
	beforeEach(() => {
		...
		tools.context.payload = {
			...
			release: {
				url:
					"https://api.github.com/repos/Codertocat/Hello-World/releases/11248810",
				assets_url:
					"https://api.github.com/repos/Codertocat/Hello-World/releases/11248810/assets",
				upload_url:
					"https://uploads.github.com/repos/Codertocat/Hello-World/releases/11248810/assets{?name,label}",
				html_url:
					"https://github.com/Codertocat/Hello-World/releases/tag/0.0.1",
				id: 11248810,
				...
				assets: [],
				tarball_url:
					"https://api.github.com/repos/Codertocat/Hello-World/tarball/0.0.1",
				zipball_url:
					"https://api.github.com/repos/Codertocat/Hello-World/zipball/0.0.1",
				body: "Testing"
			},
			repository: {
				id: 135493233,
